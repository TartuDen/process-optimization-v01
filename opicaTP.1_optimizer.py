...
VARIABLES = [
    # {"type": "Real",     "name": "T_C",        "low": 85.0, "high": 90.0, "unit": "°C"},
    # {"type": "Real",     "name": "time_h",     "low": 1.0,  "high": 24.0, "unit": "h"},
    {"type": "Real", "name": "NH2OH", "low": 2.0, "high": 3.0, "unit": "equiv"},
    {"type": "Real", "name": "Et3N", "low": 1.0, "high": 3.0, "unit": "equiv"},
    {"type": "Real", "name": "EtOH", "low": 0, "high": 15.0, "unit": "volume"},
    {"type": "Real", "name": "H2O", "low": 0, "high": 15.0, "unit": "volume"},
    {
        "type": "Real",
        "name": "NH2OH_addition_time",
        "low": 0,
        "high": 12.0,
        "unit": "hours",
    },
...
OUTPUTS = [
    {"name": "yield_pct", "kind": "max", "target": 100.0, "weight": 0.2},
    {"name": "purity_pct", "kind": "max", "target": 100.0, "weight": 0.2},
    {"name": "imp_rrt3_16_pct", "kind": "min", "weight": 0.2},
    {"name": "imp_rrt3_26_pct", "kind": "min", "weight": 0.2},
    {"name": "imp_rrt3_96_pct", "kind": "min", "weight": 0.2},
...
EMBEDDED_PAST_RUNS = [
    ...
    },
    {
        "vars": {
            ...
            "EtOH": 15.0,
            "H2O": 0.0,
            "NH2OH_addition_time": 7.0,
        },
        "outputs": {
            "yield_pct": 86.0,
            "purity_pct": 98.7,  # isolated material IP.1
            "imp_rrt3_16_pct": 4.98,  # RM aliquot
            "imp_rrt3_26_pct": 0.60,  # RM aliquot
            "imp_rrt3_96_pct": 0.44,  # RM aliquot
        },
    },
    # OPA65 — 12.09.2025
    {
        "vars": {
            ...
            "EtOH": 14.9,
            "H2O": 0.0,
            "NH2OH_addition_time": 2.0,
        },
        "outputs": {
            "yield_pct": 67.5,
            "purity_pct": 99.18,  # isolated material IP.1
            "imp_rrt3_16_pct": 4.90,  # RM aliquot
            "imp_rrt3_26_pct": 2.20,  # RM aliquot
            "imp_rrt3_96_pct": 0.0,  # not reported in RM aliquot
        },
    },
    # OPA66 — 26.09.2025
    {
        "vars": {
            ...
            "EtOH": 5.0,
            "H2O": 3.0,
            "NH2OH_addition_time": 7.5,
        },
        "outputs": {
            "yield_pct": 40.0,
            "purity_pct": 50.0,  # isolated material not reported
            "imp_rrt3_16_pct": 3.10,  # RM aliquot
            "imp_rrt3_26_pct": 23.20,  # RM aliquot
            "imp_rrt3_96_pct": 1.63,  # RM aliquot
        },
    },
    # experiment": "TP.1 → IP.1 (5 g scale, YP470)
    {
        "vars": {
            "NH2OH": 2.5,
            "Et3N": 1.0,
            "EtOH": 14.9,
            "H2O": 0,
            "NH2OH_addition_time": 5.775,
        },
        "outputs": {
            "yield_pct": 74.0,
            "purity_pct": 97.7,  # isolated material not reported
            "imp_rrt3_16_pct": 0,  # RM aliquot
            "imp_rrt3_26_pct": 2.14,  # RM aliquot
            "imp_rrt3_96_pct": 0,  # RM aliquot
        },
    },
    {
    # experiment": "TP.1 → IP.1 (15 g scale, YP476),
    "vars": {
        "NH2OH": 2.5,               #
        "Et3N": 1.0,                # 
        "EtOH": 14.9,               #
        "H2O": 0,                # 
        "NH2OH_addition_time": 5.67 # h (5 h 40 min)
    },
    "outputs": {
        "yield_pct": 74.5,              # assay-corrected
        "purity_pct": 96.2,            #
        "imp_rrt3_16_pct": 0,
        "imp_rrt3_26_pct": 2.28,
        "imp_rrt3_96_pct": 0
    }
}
    # {
...
# Files
HISTORY_CSV = Path("opica_tp1_history.csv")
STATE_PKL = Path("opica_tp1_optimizer.pkl")
