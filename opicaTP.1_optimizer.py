...
VARIABLES = [
    ...
    {"type": "Real",     "name": "NH2OH*HCl",      "low": 2.0,   "high": 3.0,   "unit": "equiv"},
    {"type": "Real",     "name": "EtOH",      "low": 2.0,   "high": 10.0,   "unit": "volume"},
    {"type": "Real",     "name": "H2O",      "low": 0.0,   "high": 10.0,   "unit": "volume"},
...
OUTPUTS = [
    ...
    {"name": "imp_RRT3.16_pct",  "kind": "min",                    "weight": 0.80},
