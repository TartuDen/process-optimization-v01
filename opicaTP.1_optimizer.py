...
VARIABLES = [
    ...
    {"type": "Real", "name": "nh2oh_hcl",   "low": 2.0,  "high": 3.0,  "unit": "equiv"},
    {"type": "Real", "name": "et3n",   "low": 2.0,  "high": 3.0,  "unit": "equiv"},
...
OUTPUTS = [
    {"name": "yield_pct",  "kind": "max",    "target": 100.0, "weight": 0.1},
    {"name": "purity_pct", "kind": "max",    "target": 100.0, "weight": 0.1},
    {"name": "imp_RRT3.16_pct",  "kind": "min",                     "weight": 0.8},
...
# Files
HISTORY_CSV = Path("opic_tp1_history.csv")
STATE_PKL   = Path("opic_tp.1_optimizer.pkl")
